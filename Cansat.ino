...
{
  char status;
  double T, P, p0, a; //Creating variables for temp, pressure and relative pressure
    ...
    if (status != 0) {
      ...
      if (status != 0) {
        ...
        if (status != 0) {
          ...
          myFile.print("Pressure measurement: ");
          myFile.print(P);
          myFile.println(" hPa");

          p0 = pressure.sealevel(P, 129);
...
//  MadgwickQuaternionUpdate(ax, ay, az, gx*PI/180.0f, gy*PI/180.0f, gz*PI/180.0f,  my,  mx, mz);
  //MahonyQuaternionUpdate(ax, ay, az, gx*PI/180.0f, gy*PI/180.0f, gz*PI/180.0f, my, mx, mz);
    ...
    Serial.print("X-acceleration: "); Serial.print(ax); Serial.print(" g ");
    Serial.print("Y-acceleration: "); Serial.print(ay); Serial.print(" g ");
    Serial.print("Z-acceleration: "); Serial.print(az); Serial.println(" g ");
   ...
   // Print temperature in degrees Centigrade
    Serial.print("Temperature (IMU) is ");  Serial.print(temperature, 1);  Serial.println(" degrees C\n"); // Print T values to tenths of s degree C

    Serial.print("ax: ");Serial.print(ax);Serial.print(", ay:");Serial.print(ay);Serial.print(", az:");Serial.print(az);
    Serial.print("\ngx:");Serial.print(gx,3);Serial.print(", gy:");Serial.print(gy, 3);Serial.print(", gz:");Serial.print(gx, 3);
    Serial.print("\nMx:");Serial.print(mx);Serial.print(", My:");Serial.print(my);Serial.print(", Mz:");Serial.print(mz);Serial.print("\n\n");
    }
